        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              ...
              <div className="bg-orange-600/10 text-orange-600 p-3 rounded-xl">
                ...
                {filteredProdutos.map((produto) => {
                  ...
                  return (
                    <TableRow key={produto.id}>
                      ...
                      <TableCell>
                        <span
                          className={isLowStock ? "text-orange-600 font-medium" : ""}
                        >
                      ...
                      <TableCell>
                        <Badge
                          ...
                          className={isLowStock ? "bg-orange-600" : "bg-green-600"}
                        >
